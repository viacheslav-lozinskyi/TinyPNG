            ...
            }
            {
                    ...
                    Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 1);
                {
                    context.
                        ...
                        SetSize(0, CONSTANT.PADDING.DEFAULT).
                    ...
                    context.
                        ...
                        SetSize(CONSTANT.PADDING.DEFAULT, 0).
                        Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 2);
                    context.
                        SetControl(NAME.CONTROL.PANEL).
                ...
                }
                {
                    context.
                        ...
                        SetSize(0, 30).
                        SetPadding(CONSTANT.PADDING.DEFAULT, 0, 0, 0).
                ...
                }
                {
                    context.
                        ...
                        SetAlignment(NAME.ALIGNMENT.LEFT).
                        SetSize(160, 0).
                        SetPadding(0, 0, CONSTANT.PADDING.DEFAULT * 2, 0).
