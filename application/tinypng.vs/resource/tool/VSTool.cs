...
namespace resource.tool
{
    internal class VSTool
    {
            ...
            public int OnAfterCloseSolution(object pUnkReserved)
            {
                ...
                }
                {
                    atom.Trace.GetInstance().
                        SetTrace(null, NAME.STATE.TRACE.REMOVE).
                        SetTrace("urn:tinypng:id:ROOT", NAME.STATE.TRACE.REMOVE).
        ...
        {
            context.
                SetTrace("urn:tinypng:id:ROOT", NAME.STATE.TRACE.RESEND | NAME.STATE.TRACE.BLINK | NAME.STATE.TRACE.EXPAND | NAME.STATE.TRACE.SHOW | NAME.STATE.TRACE.CLEAR | NAME.STATE.TRACE.PIN).
            ...
            {
                context.
                    SetTrace("urn:tinypng:hmi:ROOT", NAME.STATE.TRACE.UPDATE).
                    ...
                    Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 1);
                {
                    context.
                        ...
                        SetSize(0, CONSTANT.HMI.DEFAULT_PADDING).
                    ...
                    context.
                        ...
                        SetSize(CONSTANT.HMI.DEFAULT_PADDING, 0).
                        Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 2);
                    context.
                        SetControl(NAME.CONTROL.PANEL).
                ...
                }
                {
                    context.
                        ...
                        SetFont(null, 20, NAME.STATE.FONT.BOLD).
                        SetSize(0, 30).
                        SetPadding(CONSTANT.HMI.DEFAULT_PADDING, 0, 0, 0).
                ...
                }
                {
                        ...
                        Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 2);
                    {
                        context.
                            ...
                            SetFont(null, 16, NAME.STATE.FONT.NONE).
                            SetMargin(0, CONSTANT.HMI.DEFAULT_PADDING * 2).
                        ...
                        context.
                            ...
                            SetSize(0, 1).
                            SetMargin(0, CONSTANT.HMI.DEFAULT_PADDING * 3).
                            Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 3);
                        context.
                            SetControl(NAME.CONTROL.LABEL).
                            SetAlignment(NAME.ALIGNMENT.BOTTOM).
                            SetForeground(NAME.COLOR.GRAY).
                            SetFont(null, 10, NAME.STATE.FONT.NONE).
                            Send(NAME.SOURCE.REFACTORING, NAME.EVENT.CONTROL, 3, "$(SOLUTION_FOLDER)/tinypng.json");
                        context.
                            SetControl(NAME.CONTROL.LABEL).
                            SetAlignment(NAME.ALIGNMENT.BOTTOM).
                            SetForeground(NAME.COLOR.GRAY).
                ...
                {
                    context.
                        SetControl(NAME.CONTROL.BUTTON, "[[[Run optimization of all not optimized files]]]", TinyPNG.CONSTANT.PIPE, NAME.STATE.CONTROL.NONE).
                        SetAlignment(NAME.ALIGNMENT.RIGHT).
                        SetAlignment(NAME.ALIGNMENT.BOTTOM).
                        SetForeground(NAME.COLOR.BLACK).
                        SetBackground(NAME.COLOR.ROYAL_BLUE).
                        SetFont(null, 16, NAME.STATE.FONT.BOLD).
                        SetTrace("urn:tinypng:hmi:OPTIMIZE", NAME.STATE.TRACE.UPDATE | NAME.STATE.TRACE.BLINK).
                        SetSize(250, 30).
        ...
        private static void __ShowFiles(atom.Trace context, List<string> files, string folder)
        {
            ...
            {
                context.
                    SetTrace("urn:tinypng:hmi:ALL", NAME.STATE.TRACE.UPDATE).
            ...
            foreach (var a_Context in files)
            {
                ...
                if (a_Name1.Length > 0)
                {
                    if (a_Name != a_Name1)
                    {
                        ...
                        {
                            context.
                                SetTrace("urn:tinypng:folder:" + a_Name, NAME.STATE.TRACE.UPDATE).
                    ...
                    {
                        context.
                            SetTrace("urn:tinypng:file:" + a_Context, NAME.STATE.TRACE.UPDATE).
